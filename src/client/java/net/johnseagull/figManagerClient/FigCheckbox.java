...
public class FigCheckbox extends AbstractButton {
    ...
    public int w;
    private FigCheckbox(
            final int x, final int y, final int maxWidth, final Component message, final Font font, final boolean selected, final OnValueChange onValueChange
    ) {
    ...
    public static class Builder {
        ...
        public FigCheckbox build() {
            OnValueChange onChange = this.option == null ? this.onValueChange : (FigCheckbox, value) -> {
