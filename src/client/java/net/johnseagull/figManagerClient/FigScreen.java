                ...
                try {
                    ...
                    if (option instanceof FigList l) {
                        ...
                        try {
                            ...
                            Minecraft.getInstance().player.displayClientMessage(Component.literal("Format error for " + String.valueOf(option.getMessage())).withStyle(ChatFormatting.RED),false);
                        }
                    }
        ...
        if (this.HAS_SERVER) {
            ...
            try {
                if (errorCount == 0) {
                    ...
                    Minecraft.getInstance().player.displayClientMessage(Component.literal(""),false);
                    Minecraft.getInstance().player.displayClientMessage(Component.literal("Figs that were invalid were reset.").withStyle(new ChatFormatting[]{ChatFormatting.RED, ChatFormatting.BOLD}),false);
                }
