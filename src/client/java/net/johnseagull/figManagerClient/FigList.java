        ...
        if (this.isMap) {
            for(Map.Entry<String, String> entry : this.map.entrySet()) {
                if (this.y >= this.Y && this.y <= this.Y + this.height) {
                    graphics.text(Minecraft.getInstance().font, (String)entry.getKey(), this.X, this.y, -1);
                    graphics.text(Minecraft.getInstance().font, (String)entry.getValue(), this.X + this.width / 2, this.y, -1);
                }
            ...
            for(String s : this.list) {
                if (this.y >= this.Y && this.y <= this.Y + this.height) {
                    graphics.text(Minecraft.getInstance().font, s, this.X, this.y, -1);
                }
